-- =============================================================================
-- gold_tarifa_por_rota
--    Mapeamento completo de tarifas aplicadas a cada rota,
--    distinguindo SPTrans (BRL 4.40) de CPTM/integração.
-- =============================================================================
CREATE OR REPLACE TABLE sptrans_catalog.gtfs_data.gold_tarifa_por_rota
USING DELTA
COMMENT 'Tarifação vigente por rota com atributos completos de preço e transferência'
TBLPROPERTIES (
...
FROM tarifa_rota
ORDER BY operador, numero_linha;
